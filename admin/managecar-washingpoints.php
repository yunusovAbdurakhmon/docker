...
while($i = mysqli_fetch_assoc($response)){
	echo "<tr><td>".$i['id']."</td>";
	echo "<td>".$i['washingPointName']."</td>";
    echo "<td>".$i['washingPointAddress']."</td>";
    echo "<td>".$i['contactNumber']."</td>";
	echo "<td>".$i['creationDate']."</td>";
	echo "<td><a href='editcar-washpoint.php?wpid=".$i['id']."'>Edit</a></td>";
	echo "<br></tr>";
