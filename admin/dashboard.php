					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								...
								<?php 
								$query = "SELECT COUNT(*) FROM tblcarwashbooking";
								$result = mysqli_query($connect,$query);
								$rows = mysqli_fetch_row($result);
								
								?>
								<h4> <?php echo $rows[0]; ?> </h4>
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>New Bookings</h3>
							<?php 
							$query = "SELECT COUNT(*) FROM tblcarwashbooking where status='New'";
							$result = mysqli_query($connect,$query);
							$rows = mysqli_fetch_row($result);
							?>
								<h4><?php echo $rows[0]; ?></h4>
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								...
								<?php 
							$query = "SELECT COUNT(*) FROM tblcarwashbooking where status='Completed'";
							$result = mysqli_query($connect,$query);
							$rows = mysqli_fetch_row($result);
							?>
						...
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Washing Points</h3>
									<?php
									$query = "SELECT COUNT(*) FROM tblwashingpoints";
									$result = mysqli_query($connect,$query);
									$rows = mysqli_fetch_row($result);
									?>
								<h4><?php echo $rows[0];?></h4>
