...
$query = "Update tblwashingpoints Set washingPointName='$wpname',washingPointAddress='$wpaddress',contactNumber='$wpcnumber' Where id='$id'";
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="washingpointname" id="washingpointname" value="<?php echo $i['washingPointName'];?>" required>
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Adress</label>
									<div class="col-sm-8">
										<textarea class="form-control" name="address" id="address" placeholder="Address" required rows="4"><?php echo $i['washingPointAddress'];?></textarea>
									</div>
								</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="contactno" id="contactno" value="<?php echo $i['contactNumber'];?>" required>
									</div>
								</div>
